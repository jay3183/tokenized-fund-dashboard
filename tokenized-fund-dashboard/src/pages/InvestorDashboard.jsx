      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white shadow-md rounded-xl p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-slate-800">Your Account</h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4 text-left text-slate-700">
            <div>
        ...
        <div className="mb-6 flex justify-center">
          {isLoading ? (
            <div className="bg-white shadow-md rounded-xl p-8 animate-pulse w-full">
            ...
            <PortfolioProvider>
              <PortfolioPanel 
                fundId="F1" 
                investorId={user?.id ? user.id.toString() : ''} 
          ...
          <div className={isLoading ? "animate-pulse" : ""}>
            {isLoading ? (
              <div className="bg-white shadow-md rounded-xl p-6 h-80">
                ...
                <div className="h-40 bg-slate-200 rounded my-4"></div>
        ...
        <div className="bg-white shadow-md rounded-xl p-6 border-t-4 border-primary">
          <h3 className="font-semibold text-slate-800 mb-2">Franklin Templeton Fund Information</h3>
